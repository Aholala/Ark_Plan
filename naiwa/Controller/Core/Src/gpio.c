...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, OLED_SCL_Pin|OLED_SDA_Pin|NRF_CE_Pin|NRF_CSN_Pin
                          |NRF_SCK_Pin|NRF_MOSI_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : KEY11_Pin KEY12_Pin KEY1_Pin KEY2_Pin
                           KEY7_Pin KEY8_Pin */
  GPIO_InitStruct.Pin = KEY11_Pin|KEY12_Pin|KEY1_Pin|KEY2_Pin
                          |KEY7_Pin|KEY8_Pin;
  ...
  GPIO_InitStruct.Pin = KEY3_Pin|KEY4_Pin|KEY5_Pin|KEY6_Pin
                          |KEY9_Pin|KEY10_Pin|NRF_MISO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
